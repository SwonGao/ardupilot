...
double BiQuad::step(double x) {
    ...
    wz[1] = B[2] * x - A[1] * y;
    //std::cout << "A: " << A[0] << ","<< A[1] << "B: "<< B[0] <<","<< B[1]  <<","<<B[2] <<"wz: " << wz[0] <<","<<wz[1]<< std::endl;
    return y;
}
...
void BiQuadChain::setintegral() {
    // std::cout << "ininininininininininininininininininin" << std::endl;
    size_t i;
    size_t bqs;
